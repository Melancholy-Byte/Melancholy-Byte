...
* 🎓 **B.Tech in Electrical Engineering** @ **IIT**
* 🔬 **Innovator** in **Digital Design**, **FPGA**, and **Hardware Accelerators**
* 🛡️ **Defense Tech Collaborator**: Projects with defense applications (LWS, Aerial Vehicle Protection)
* 🏆 **Research Highlights**: IEEE ESL paper (Aug 2025) · Multi-width verification harness · FPGA implementations
* 📬 **Email**: saurav@example.com | 269saurav@gmail.com
* 🌐 **Portfolio**: [melancholy-byte.github.io](https://melancholy-byte.github.io)

---

## 📘 Relevant Coursework

| **💡 Core:**            | Data Structures & Algorithms, Control Systems, Signal Processing, Digital Communication |
| ----------------------- | --------------------------------------------------------------------------------------- |
| **🤖 Specialization:**  | VLSI, Embedded Systems, FPGA Design, Robotics & Automation, Digital Signal Processing   |
| **📡 Domain-Specific:** | Hardware Description Languages, Verification Methodologies, Hardware-Software Co-design, DSP Algorithms |
...
- 📄 **IEEE Embedded Systems Letters** - Paper on Hybrid Recursive Karatsuba Multiplications (Aug 2025)
- 🔬 **Research Contributions** - Multi-width verification harness, deterministic test vectors, FPGA optimizations
- 🤝 **Collaborative Projects** - Defense tech (LWS), robotics, autonomous systems, signal processing
- 🛠️ **Open Source** - FPGA implementations, hardware modules, verification frameworks
- 🎯 **Technical Expertise** - Digital design, hardware acceleration, embedded systems
